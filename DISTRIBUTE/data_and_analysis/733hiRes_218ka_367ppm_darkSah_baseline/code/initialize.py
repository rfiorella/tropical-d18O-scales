...
init = {
    ...
    # CASE SETP + INPUTS --------------------------------- #
    # ---------------------------------------------------- #
    "run_name":   "733hiRes_218ka_367ppm_darkSah_baseline",                # must also be dir name
    ...
    "Tau-bar_localThreshold": 750,                  # [km] distance from sink point where we consider climatology to be local
    ...
    "Tau-bar_DtauFraction": 0.66,          # [value 0-1] fraction of total Dtaubar that we want to attribute to "local" change, computing the distance before this fraction is achieved
